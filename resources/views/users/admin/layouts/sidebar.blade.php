...
<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside" style="background-color: green;">
    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div >
            ...
            <h3 style="color:#008000">JD CLINIC HEALTH SYSTEM</h3>
        </div>
    ...
    <div>
        <div id="kt_aside_menu"
             ...
             data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" style="  color:white">

            <ul class="kt-menu__nav ">
                <li class="kt-menu__section kt-menu__section--first">
                    <h4 class="kt-menu__section-text"><h4>Patient & Doctors</h4></h4>
